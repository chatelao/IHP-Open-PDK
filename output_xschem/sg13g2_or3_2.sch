...
C {sg13g2_pr/sg13_lv_nmos.sym} 200 100 0 0 {name=XX1 model=sg13_lv_nmos spiceprefix=X w=1.48u l=130.00n ng=2 ad=2.812e-13 as=5.032e-13 pd=2.24e-06 ps=4.32e-06 m=1 }
...
C {sg13g2_pr/sg13_lv_pmos.sym} 800 -100 0 0 {name=XX2 model=sg13_lv_pmos spiceprefix=X w=2.24u l=130.00n ng=2 ad=4.256e-13 as=7.616e-13 pd=3e-06 ps=5.84e-06 m=1 }
