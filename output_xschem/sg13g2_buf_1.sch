...
C {sg13g2_pr/sg13_lv_nmos.sym} 0 100 0 0 {name=XN1 model=sg13_lv_nmos spiceprefix=X w=550.00n l=130.00n ng=1 ad=1.87e-13 as=1.87e-13 pd=1.78e-06 ps=1.78e-06 m=1 }
...
C {sg13g2_pr/sg13_lv_nmos.sym} 200 100 0 0 {name=XN0 model=sg13_lv_nmos spiceprefix=X w=740.00n l=130.00n ng=1 ad=2.516e-13 as=2.516e-13 pd=2.16e-06 ps=2.16e-06 m=1 }
...
C {sg13g2_pr/sg13_lv_pmos.sym} 400 -100 0 0 {name=XP1 model=sg13_lv_pmos spiceprefix=X w=1.12u l=130.00n ng=1 ad=3.808e-13 as=3.808e-13 pd=2.92e-06 ps=2.92e-06 m=1 }
